...
func _chart() -> Dictionary:
	return {
		...
		"durationMs": 5000,
		"notes": [
			{"id": 1, "lane": 0, "startMs": 1000.0, "measure": 0, "endMs": null, "sampleId": 1, "volume": 0.8, "pan": -0.2, "kind": "tap"},
			{"id": 2, "lane": 1, "startMs": 2000.0, "measure": 0, "endMs": null, "sampleId": 2, "volume": 0.9, "pan": 0.1, "kind": "tap"},
...
func _autosound_suppression_chart() -> Dictionary:
	return {
		...
		"notes": [
			{"id": 1, "lane": 0, "startMs": 1000.0, "measure": 0, "endMs": null, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
			{"id": 2, "lane": 1, "startMs": 1300.0, "measure": 0, "endMs": null, "sampleId": 2, "volume": 1.0, "pan": 0.0, "kind": "tap"},
		],
		"autoPlayEvents": [],
	}
...
func _non_vos_rejected_keysound_chart() -> Dictionary:
	return {
		...
		"durationMs": 3000,
		"notes": [
			{"id": 7, "lane": 0, "startMs": 1000.0, "measure": 0, "endMs": null, "sampleId": 7, "volume": 1.0, "pan": 0.0, "kind": "tap"},
		],
		"autoPlayEvents": [],
	}
