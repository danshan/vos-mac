...
godot --headless --path rewrite/godot --script res://scripts/tests/main_ui_catalog_export_flow_test.gd
godot --headless --path rewrite/godot --script res://scripts/tests/main_ui_export_flow_test.gd
...
godot --headless --path rewrite/godot --script res://scripts/tests/gameplay_audio_java_parity_test.gd
godot --headless --path rewrite/godot --script res://scripts/tests/gameplay_runtime_test.gd
