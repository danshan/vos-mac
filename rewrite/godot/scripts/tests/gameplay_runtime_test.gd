...
func _test_java_fps_timer(chart: Dictionary, audio_manifest: Dictionary) -> bool:
	...
	long_chart["notes"] = [
		{"id": 1, "lane": 0, "startMs": 70000.0, "measure": 0, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
	]
	var runtime = GameplayRuntime.new()
	get_root().add_child(runtime)
...
func _test_java_haste_mode_pitch_sync(audio_manifest: Dictionary) -> bool:
	var chart := {
		...
		"notes": [
			{"id": 1, "lane": 0, "startMs": 6100.0, "measure": 6, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
			{"id": 2, "lane": 1, "startMs": 9200.0, "measure": 9, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
		],
		"measures": [
			{"startMs": 0.0},
			{"startMs": 1000.0},
...
func _test_java_manual_start_gates_game_time(audio_manifest: Dictionary) -> bool:
	var chart := {
		...
		"durationMs": 3000,
		"notes": [
			{"id": 1, "lane": 0, "startMs": 0.0, "measure": 0, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
		],
		"autoPlayEvents": [],
	}
	var runtime = GameplayRuntime.new()
...
func _test_java_finish_waits_for_note_layer(audio_manifest: Dictionary) -> bool:
	var chart := {
		...
		"durationMs": 3000,
		"notes": [
			{"id": 1, "lane": 0, "startMs": 12000.0, "measure": 0, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
		],
		"autoPlayEvents": [],
	}
	var runtime = GameplayRuntime.new()
...
func _test_java_buffered_visual_entities_match_render_window(audio_manifest: Dictionary) -> bool:
	var note_chart := {
		...
		"notes": [
			{"id": 1, "lane": 0, "startMs": 1000.0, "measure": 0, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
			{"id": 2, "lane": 1, "startMs": 3000.0, "measure": 0, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
			{"id": 3, "lane": 2, "startMs": 6000.0, "measure": 0, "sampleId": 1, "volume": 1.0, "pan": 0.0, "kind": "tap"},
		],
		"autoPlayEvents": [],
	}
